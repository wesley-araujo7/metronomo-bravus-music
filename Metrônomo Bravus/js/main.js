...
menosUm.addEventListener('click', function () {
    let diminuiUm = bpm.innerHTML = bpm.value -= 1;
...
maisUm.addEventListener('click', function () {
    let aumentaUm = bpm.innerHTML = bpm.value++;
...
menosCinco.addEventListener('click', function () {
    let diminuiCinco = bpm.innerHTML = bpm.value -= 5;
...
maisCinco.addEventListener('click', function () {
    ...
    let aumentaCinco = bpm.innerHTML = bpm.value++;

    if( aumentaCinco % 5 == 0 ) {
         parseInt( Math.floor( bpm.value++ / 5 ) ) * 5;
         parseInt( Math.floor( bpm.value++ / 5 ) ) * 5;
         parseInt( Math.floor( bpm.value++ / 5 ) ) * 5;
         parseInt( Math.floor( bpm.value++ / 5 ) ) * 5;
    } else {
         ( parseInt( Math.floor( bpm.value++ / 5 ) ) * 5 ) + 5;
         ( parseInt( Math.floor( bpm.value++ / 5 ) ) * 5 ) + 5;
         ( parseInt( Math.floor( bpm.value++ / 5 ) ) * 5 ) + 5;
         ( parseInt( Math.floor( bpm.value++ / 5 ) ) * 5 ) + 5;
    }
